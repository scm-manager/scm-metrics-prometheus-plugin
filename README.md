...
Provide SCM-Manager Metrics for Prometheus

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-metrics-prometheus-plugin/docs).

## Testing

In order to test the plugin with prometheus, docker in version 20.10 or higher na docker-compose is required.
...
Prometheus is already configured to scrape scm-manager and should be running at http://localhost:9090
